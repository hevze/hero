...
import com.hero.core.mybatis.interceptor.ExecutorInterceptor;
 ...
 * @param <T>
 */
public abstract class BaseDaoImpl<T extends BaseIdEntity> extends SqlSessionDaoSupport implements BaseDao<T> {
