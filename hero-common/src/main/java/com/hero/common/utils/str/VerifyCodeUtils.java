...
//        ImageIO.write(image, "jpg", os);
     ...
     * @throws IOException
     */
    public static Map<String, Object> getCode() throws IOException {
        int w = width, h = height;
        String verifyCode = generateVerifyCode(4);
        BufferedImage bufferedImage = outputImage(w, h, verifyCode);
    ...
    public static void main(String[] args) {
        try {
            Map<String,Object> map = VerifyCodeUtils.getCode();
